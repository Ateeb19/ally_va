        ...
        <div class="modal-content rounded-3 shadow">
          ...
          <div class="modal-body">
            ...
            <form method="POST" action="{{ route('user.store') }}" class="vstack gap-3" id="AddUserForm">
              ...
              <button type="submit" class="btn btn-primary w-100" id="addUserBtn">
                <span class="btn-text">Create Account</span>
                <img src="{{ asset('images/ally-loader_yellow.gif') }}" id="addUserLoader" class="loader-gif"
                  style="display:none; height:20px;" alt="Processing">
              </button>
            </form>
            <script>
              document.getElementById("AddUserForm").addEventListener("submit", function () {

                const btnText = document.querySelector("#addUserBtn .btn-text");
                const loader = document.getElementById("addUserLoader");
            ...
            <form action="{{ route('paypal.payment') }}" method="GET" id="paypalForm">
              <div class="d-flex flex-row justify-content-between align-items-center mt-4 gap-3">
                ...
                <button type="submit" class="text-white fw-semibold shadow py-2 buy-btn " id="buyBtn">
                  ...
                  <img src="{{ asset('images/ally-loader_yellow.gif') }}" id="buyLoader" class="loader-gif"
    ...
    @if(isset($adminView) && auth()->user()->hasRole('super_admin'))
          ...
          <div class="modal-content">
            <form id="transactionForm" method="POST">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="transactionBtn">
                  <span class="btn-text">Save</span>
                  <img src="{{ asset('images/ally-loader_yellow.gif') }}" id="transactionLoader" style="display:none;"
                    width="20">
                </button>
              </div>
            </form>
      ...
      <script>
        document.addEventListener("DOMContentLoaded", function () {
          ...
          const text = document.querySelector("#transactionBtn .btn-text");
