...
<html>
  <body>
    ...
    <p>Thanks for registering at our platform.</p>
    ...
    tailwind.config= {
      theme: {
        extend: {
          colors: {
            'ally-primary': '#10B981',
              /* Emerald 500 (Used for header and links) */
              'ally-light': '#D1FAE5',
              /* Emerald 100 */
              'ally-blue': '#288feb',
              /* Custom Blue for CTA Button */
          }
...
<body class="bg-gray-100 min-h-screen p-4 sm:p-8">
  ...
  <div class="max-w-xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden">
    ...
    <main class="p-8 sm:p-10 text-gray-800">
      ...
      <p class="text-lg mb-6 text-gray-700">
        I'm Arup, and I'm here to ensure you receive immediate virtual assistance. To get started right away, please
        email your tasks and requests directly to me at:
      </p>

      <!-- Email Address - No longer highlighted, now aligned left (text-left) -->
      <div class="mb-6 text-left">
        <a href="mailto:arupkseth@gmail.com" class="text-lg font-semibold text-ally-primary hover:underline"
